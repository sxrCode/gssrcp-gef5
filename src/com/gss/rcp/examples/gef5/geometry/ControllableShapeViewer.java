 ...
 *     
 *******************************************************************************/
package com.gss.rcp.examples.gef5.geometry;
...
public class ControllableShapeViewer implements PaintListener, MouseListener, MouseMoveListener, Listener {
	...
	public void paintControl(PaintEvent e) {
		...
		for (ControllableShape shape : shapes) {
			if (shape.isActive()) {
				e.gc.setForeground(canvas.getDisplay().getSystemColor(shape.controlColor));
				e.gc.setBackground(canvas.getDisplay().getSystemColor(shape.controlColor));

				for (ControlPoint cp : shape.controlPoints) {
					e.gc.fillOval((int) (cp.getX() - shape.controlRadius), (int) (cp.getY() - shape.controlRadius),
							(int) (shape.controlRadius * 2), (int) (shape.controlRadius * 2));
				}
			}
		}
	}
