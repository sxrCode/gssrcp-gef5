 ...
 *
 *******************************************************************************/
package com.gss.rcp.examples.gef5.graph;
...
public final class GraphBuilderExample {
	...
	public static void main(final String[] args) {
		...
		Graph g1 = new Graph.Builder().attr(DotAttributes::_setType, GraphType.DIGRAPH)//
				.node("n1")//
		...
		Graph g2 = new Graph.Builder().attr(DotAttributes::_setType, GraphType.DIGRAPH)//
				...
				.attr(DotAttributes::setLabel, "3")//
				.attr(DotAttributes::setId, "3")//
				.edge("n1", "n2").attr(DotAttributes::setLabel, "e1").edge("n1", "n3").build();
		...
		Graph g3 = new Graph.Builder().attr(DotAttributes::_setType, GraphType.DIGRAPH).nodes(n1, n2, n3)//
				.edge(n1, n2)//
				.edge(n1, n3)//
				.build();
	}
