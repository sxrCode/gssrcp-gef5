...
public class CustomLayoutExample extends AbstractZestExample {
	...
	protected Graph createGraph() {
		// create nodes
		org.eclipse.gef.graph.Node[] nodes = new org.eclipse.gef.graph.Node[] { n(LABEL, "Paper"), n(LABEL, "Rock"),
				n(LABEL, "Scissors"), };

		// create edges
		org.eclipse.gef.graph.Edge[] edges = new org.eclipse.gef.graph.Edge[] { e(nodes[0], nodes[1]),
				e(nodes[1], nodes[2]) };
