...
public class SugiyamaLayoutExample extends AbstractZestExample {
	...
	protected Graph createGraph() {
		// create nodes
		org.eclipse.gef.graph.Node[] nodes = new org.eclipse.gef.graph.Node[] { n(LABEL, "Coal"), n(LABEL, "Ore"),
		...
		org.eclipse.gef.graph.Edge[] edges = new org.eclipse.gef.graph.Edge[] {
				e(nodes[0], nodes[3]) /* coal -> metal */, e(nodes[0], nodes[4]) /* coal -> concrete */,
				e(nodes[3], nodes[5]) /* metal -> machine */, e(nodes[3], nodes[6]) /* metal -> building */,
				e(nodes[4], nodes[6]) /* concrete -> building */, e(nodes[1], nodes[3]) /* ore -> metal */,
