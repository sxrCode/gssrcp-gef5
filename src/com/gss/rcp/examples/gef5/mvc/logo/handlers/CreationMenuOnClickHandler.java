...
public class CreationMenuOnClickHandler extends AbstractHandler implements IOnClickHandler {
	...
	public static interface ICreationMenuItem {
		...
		/**
		 * Returns a newly created content element that is added to the viewer when this
		 * menu item is selected.
		 *
		 * @return The content element that is created when this menu item is selected.
		 */
	...
	/**
	 * Stores the padding around visuals used to circumvent translation issues when
	...
	/**
	 * Returns the list containing the {@link ICreationMenuItem}s that are displayed
	 * by this policy.
	 *
	 * @return the list containing the {@link ICreationMenuItem}s that are displayed
	 *         by this policy.
	 */
	...
	/**
	 * Returns <code>true</code> if the creation menu is currently open. Otherwise
	 ...
	 *
	 * @param previous
	 *            <code>true</code> to show the previous item, <code>false</code> to
	 *            show the next item.
	 */
