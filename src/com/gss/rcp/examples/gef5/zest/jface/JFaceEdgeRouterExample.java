 ...
 *
 *******************************************************************************/
package com.gss.rcp.examples.gef5.zest.jface;
...
public class JFaceEdgeRouterExample {
	...
	static class MyLabelProvider extends LabelProvider implements IGraphAttributesProvider {
		...
		public Map<String, Object> getEdgeAttributes(Object sourceNode, Object targetNode) {
			return Collections.<String, Object>singletonMap(ZestProperties.ROUTER__E, new OrthogonalRouter());
		}
